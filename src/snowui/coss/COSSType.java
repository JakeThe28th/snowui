...
public record COSSType(ArrayList<String> contains, HashMap<String, COSSProperty> properties) {
	public COSSType() { this(new ArrayList<String>(), new HashMap<String, COSSProperty>()); }
}